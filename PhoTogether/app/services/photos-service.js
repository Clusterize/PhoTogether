...
function _getDevicePhotos(){
    if (application.ios){
        return _getiOSPhotos();
    }
    else {
        return _getAndroidPhotos();
    }
}

exports.getDevicePhotos = _getDevicePhotos;